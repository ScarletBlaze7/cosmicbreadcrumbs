...
export const PrivateDiaryView: React.FC<PrivateDiaryViewProps> = ({ 
  ...
  return (
    <div className="space-y-6 sm:space-y-8 animate-in fade-in duration-300 pb-16">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-purple-900/50 pb-5">
        ...
        <div className="flex items-center space-x-2 self-start sm:self-auto flex-wrap gap-y-2">
          ...
          <button
            ...
            className="flex items-center space-x-1.5 rounded-xl border border-amber-400/50 bg-amber-500/10 px-3 py-1.5 text-xs font-bold text-amber-300 hover:bg-amber-500/20 hover:border-amber-400 transition-all shadow-sm"
            title="Search previous thoughts and journal chronicles"
          >
            <Search className="h-3.5 w-3.5 text-amber-400" />
            <span className="hidden sm:inline">Search Thoughts</span>
          </button>
      ...
      {/* PERMANENT FEATURED JOURNAL ARTWORK BANNER */}
                ...
                <form onSubmit={handleSaveEntry} className="space-y-6">
                  ...
                  <div className="space-y-2 rounded-2xl border border-amber-500/20 bg-amber-500/5 p-4">
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full rounded-xl border border-purple-900/60 bg-slate-950/90 p-3 text-xs text-slate-100 placeholder:text-purple-300/25 placeholder:italic placeholder:font-light focus:border-amber-400 focus:outline-none focus:ring-1 focus:ring-amber-500/30"
                    />
                  </div>
                  ...
                  <div className="space-y-3 rounded-2xl border border-indigo-500/20 bg-indigo-500/5 p-4">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className="w-full rounded-xl border border-purple-900/60 bg-slate-950/90 px-3 py-2 text-xs text-slate-100 placeholder:text-purple-300/25 placeholder:italic placeholder:font-light focus:border-amber-400 focus:outline-none"
                      />
                    </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <textarea
                        ...
                        rows={3}
                        className="w-full rounded-xl border border-purple-900/60 bg-slate-950/90 p-3 text-xs text-slate-100 placeholder:text-purple-300/25 placeholder:italic placeholder:font-light focus:border-amber-400 focus:outline-none"
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      rows={6}
                      className="w-full rounded-2xl border border-purple-800/60 bg-slate-950 p-4 text-xs text-slate-100 leading-relaxed placeholder:text-purple-300/25 placeholder:italic placeholder:font-light focus:border-amber-400 focus:outline-none focus:ring-1 focus:ring-amber-500/30"
                    />
                  </div>
