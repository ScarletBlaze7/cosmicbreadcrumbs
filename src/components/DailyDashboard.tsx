  ...
  return (
    <div className="mx-auto max-w-xl sm:max-w-2xl px-3 py-4 sm:py-6 space-y-5 animate-in fade-in duration-300 pb-20">
      ...
      <div className="space-y-4 pt-1">
        ...
        {/* Personalized Seeker Welcome Bar with Active Photo / Zodiac */}
        <div className="flex items-center justify-between rounded-3xl border border-purple-800/60 bg-gradient-to-r from-purple-950/80 via-[#0e0a22] to-purple-950/80 p-3 sm:p-4 shadow-xl backdrop-blur-md">
          <div className="flex items-center space-x-3.5">
            <div className="relative h-12 w-12 sm:h-14 sm:w-14 shrink-0 rounded-full border-2 border-amber-400 bg-slate-950 overflow-hidden shadow-[0_0_12px_rgba(251,191,36,0.5)]">
            ...
            <div>
              ...
              <p className="text-xs text-purple-200/90 font-sans">
                {sunSign.name} ({sunSign.symbol}) • Life Path #{lifePath} • Universal Alignment Active
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="relative w-full max-w-xl mx-auto rounded-3xl overflow-hidden border border-purple-500/40 shadow-2xl bg-black/50 my-2">
          <img
            src="/assets/Screenshot_20260821-045128_Chrome.png"
            onError={(e) => { 
              const target = e.currentTarget as HTMLImageElement;
              if (!target.src.includes('cosmichub.png')) {
                target.src = '/assets/cosmichub.png';
              }
            }}
      ...
      {/* CARD 4: FREE 3-DAY TRIAL & THE SANCTUARY CLUB ACCESS (PLACED DIRECTLY BELOW DAILY TAROT) */}
